...
const PandoraIcon = (props) => (
  <img src="/icons/pandora-mus.png" alt="Pandora" className={props.className} style={{ width: '1.8em', height: '1.8em', ...props.style }} />
);

// Boomplay icon
const BoomplayIcon = (props) => (
  <img src="/icons/boomplay-mus.png" alt="Boomplay" className={props.className} style={{ width: '1.8em', height: '1.8em', ...props.style }} />
);
