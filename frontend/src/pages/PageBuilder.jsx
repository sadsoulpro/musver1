...
import { 
  ...
  ChevronRight, Link2, Palette, Megaphone, Share2
} from "lucide-react";
...
const AnghamiIcon = (props) => (
  <img src="/icons/anghami-mus.png" alt="Anghami" {...props} style={{ width: props.width || '1.8em', height: props.height || '1.8em', ...props.style }} />
);

// Audius icon
const AudiusIcon = (props) => (
  <img src="/icons/audius-mus.png" alt="Audius" {...props} style={{ width: props.width || '1.8em', height: props.height || '1.8em', ...props.style }} />
);

// Bandcamp icon
const BandcampIcon = (props) => (
  <img src="/icons/bandcamp-mus.png" alt="Bandcamp" {...props} style={{ width: props.width || '1.8em', height: props.height || '1.8em', ...props.style }} />
);
...
const PLATFORMS = [
  ...
  { id: "yandex", icon: YandexMusicIcon, color: "#000000", isImage: true },
  { id: "vk", icon: VKMusicIcon, color: "#000000", isImage: true },
  ...
  { id: "audius", icon: AudiusIcon, color: "#000000", isImage: true },
  { id: "anghami", icon: AnghamiIcon, color: "#000000", isImage: true },
  { id: "boomplay", icon: BoomplayIcon, color: "#000000", isImage: true },
